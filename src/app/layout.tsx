...
// Fraunces — modern American editorial serif (replaces Playfair's Dubai-luxury look).
// Keeps the --font-playfair variable name so every component picks it up unchanged.
